namespace Spi.Vs.Extensions.XamlBuildFix
{
    ...
    internal static class ProcessParameterControl_EnsureGrid_Prefix_Patch
    {
        ...
        {
            var assemblyName = "Microsoft.TeamFoundation.Build.Controls, Version=17.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a";
        ...
        public static bool Prefix(object __instance, ref object ___m_propertyGrid, ref AppDomain ___m_gridDomain, object ___m_additionalServices)
        {
            // Org:
            ///////////////////////////////////////////////////
            ...
            var typeName = processParameterControlType.GetNestedType("ProcessParameterControlProxy", BindingFlags.Public | BindingFlags.NonPublic).FullName;
